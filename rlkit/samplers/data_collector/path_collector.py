...
from rlkit.samplers.rollout_functions import rollout,rollout_context, multitask_rollout, function_rollout
...
class MdpPathCollector_Context(PathCollector):
    def __init__(
            self,
            env,
            policy,
...
class CustomMDPPathCollector_EVAL(PathCollector):
    def __init__(
            self,
            env,
            policy,
