...
if __name__ == "__main__":
    ...
    if variant['transfer_multiview']:
        if args.buffer == 1:
            ...
            args.buffer = '/nfs/kun1/users/asap7772/roboverse/data/train_grasp/scripted_Widow250MultiObjectGraspTrain-v0_2020-12-30T00-06-52.npy'
        elif args.buffer == 3:
            args.buffer = '/nfs/kun1/users/asap7772/roboverse/data/val_grasp/scripted_Widow250MultiObjectGraspTrain-v0_2020-12-30T00-06-55.npy'
        elif args.buffer == 4:
            args.buffer = '/nfs/kun1/users/asap7772/roboverse/data/all_grasp/scripted_Widow250MultiObjectGraspTrain-v0_2020-12-30T00-06-58.npy'
        elif args.buffer == 5:
